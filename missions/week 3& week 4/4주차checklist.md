...
- [x] 리액트를 사용하여 상품 삭제
- [x] 리액트에서 JWT를 통한 인증
- [x] 리액트에서 엘라스틱 서치를 이용한 상품검색
  - 강사가 확인할 수 있는 키바나 관리자 페이지 주소 : http://3640-211-248-218-14.ngrok.io

## 수행인증영상URL(유튜브)

- https://www.youtube.com/watch?v=u6HdiFSWvyU
- 추가 영상(키바나 관리자 페이지) : https://youtu.be/0wumQB6L7tY  
