...
class Address(models.Model):
    ...
    name = models.CharField('이름', max_length=7)
    address = models.CharField('주소', max_length=255)
    postal_code = models.CharField('우편 번호', max_length=5)
    extra_address = models.CharField('상세 주소', max_length=255)
    phone = models.CharField('전화 번호', max_length=11)
