...
class BaseMerchandise(models.Model):
    id = models.AutoField(primary_key=True)
    subcategory = models.ForeignKey(SubCategory, on_delete=models.SET_NULL, null=True, verbose_name='서브카테고리')
    seller = models.ForeignKey(Seller, on_delete=models.SET_NULL, null=True, verbose_name='셀러')
...
class Merchandise(TimeStampedModel):
    id = models.AutoField(primary_key=True)
    basemerchandise = models.ForeignKey(BaseMerchandise, on_delete=models.CASCADE, null=True, verbose_name='상품')
